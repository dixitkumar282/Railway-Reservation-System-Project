...
void main()
{
    ...
    printf("Enter The Source Place: ");
     printf("\n");
    printf(" Jammu      \t Kashmir        \t Himachal Pradesh\n");
    printf(" Punjab     \t Haryana        \t Uttrakhand\n");
    printf(" New Delhi  \t Uttar Pradesh  \t Rajasthan\n");
    printf(" Gujrat     \t Madhya Pradesh \t Bihar\n");
    printf(" Jharkhand  \t West Bengal    \t Sikkim\n");
    printf(" Mumbai     \t Telangana      \t Kerela\n");
...
void details(int k)
{
    ...
    for (i = 1; i <= k; i++) {
        ...
        printf("Enter Gender of Passenger %d (male/female): ", i);

        fflush(stdin);
        gets(gen);


        printf("Enter Age of Passenger %d: ", i);
